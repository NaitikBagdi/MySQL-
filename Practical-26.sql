...
-- Delete data of employee_hobby tables
...
-- Create a separate select queries to get a hobby., , , employee_hobby.
SELECT * FROM hobby;
...
SELECT
  ...
  (
    ...
    FROM
      hobby
      INNER JOIN employee_hobby eh ON hobby.id=eh.fk_hobby_id
    WHERE
