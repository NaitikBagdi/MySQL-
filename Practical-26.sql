...
-- Create a separate select queries to get a hobby, , employee_salary, employee_hobby.
SELECT * FROM hobby;
...
SELECT CONCAT (e.first_name, ' ', e.last_name) AS employee_na me, SUM(es.salary) AS total_salary,
