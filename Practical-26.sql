...
ALTER TABLE employee_hobby
ADD CONSTRAINT fk_hobby FOREIGN KEY(fk_hobby_id) REFERENCES hobby(id)
ON DELETE CASCADE;
...
ALTER TABLE employee_salary
ADD CONSTRAINT fk_employees FOREIGN KEY(fk_employee_id) REFERENCES employee(id)
ON DELETE CASCADE;
...
(SELECT GROUP_CONCAT(hobby.name)
FROM hobby
